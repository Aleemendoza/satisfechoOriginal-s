  ...
  return [
    {
      ...
      discountable: true,
      subtitle: null,
      description: "Reimagina la sensación de una camiseta clásica. Con nuestras camisetas de algodón, los elementos esenciales del día a día ya no tienen por qué ser ordinarios.",
